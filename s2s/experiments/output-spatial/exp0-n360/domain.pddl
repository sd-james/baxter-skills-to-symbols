...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.238 (not (notfailed))
					0.762 (and (symbol_20 ?d) (symbol_12 ?c) (symbol_6 ?b) (not (symbol_13 ?d)) (not (symbol_14 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-0-1
		...
		:effect 
			(probabilistic
					0.185 (not (notfailed))
					0.815 (and (symbol_20 ?d) (symbol_12 ?c) (symbol_6 ?b) (not (symbol_13 ?d)) (not (symbol_14 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-0-2
		...
		:effect 
			(probabilistic
					0.187 (not (notfailed))
					0.813 (and (symbol_20 ?d) (symbol_12 ?c) (symbol_6 ?b) (not (symbol_13 ?d)) (not (symbol_14 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-3
		...
		:effect 
			(probabilistic
					0.212 (not (notfailed))
					0.788 (and (symbol_11 ?d) (symbol_1 ?c) (symbol_6 ?b) (not (symbol_16 ?d)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-4
		...
		:effect 
			(probabilistic
					0.321 (not (notfailed))
					0.679 (and (symbol_11 ?d) (symbol_1 ?c) (symbol_6 ?b) (not (symbol_16 ?d)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-2-6
		...
		:effect 
			(probabilistic
					0.507 (not (notfailed))
					0.493 (and (symbol_11 ?c) (symbol_15 ?b) (not (symbol_0 ?c)) (not (symbol_3 ?b))))
	)
	...
	(:action option-1-partition-0-8
		...
		:effect 
			(probabilistic
					0.411 (not (notfailed))
					0.589 (and (symbol_13 ?c) (symbol_14 ?b) (not (symbol_16 ?c)) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-0-9
		...
		:effect 
			(probabilistic
					0.285 (not (notfailed))
					0.715 (and (symbol_13 ?c) (symbol_14 ?b) (not (symbol_16 ?c)) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-1-10
		...
		:effect 
			(probabilistic
					0.712 (not (notfailed))
					0.288 (and (symbol_14 ?b) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-1-11
		...
		:effect 
			(probabilistic
					0.48 (not (notfailed))
					0.52 (and (symbol_14 ?b) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-2-15
		...
		:effect 
			(probabilistic
					0.089 (not (notfailed))
					0.911 (and (symbol_12 ?b) (not (symbol_1 ?b))))
	)
	...
	(:action option-2-partition-0-17
		...
		:effect 
			(probabilistic
					0.115 (not (notfailed))
					0.885 (and (symbol_17 ?b) (not (symbol_14 ?b))))
	)
	...
	(:action option-2-partition-0-19
		...
		:effect 
			(probabilistic
					0.12 (not (notfailed))
					0.88 (and (symbol_17 ?b) (not (symbol_14 ?b))))
	)
	...
	(:action option-2-partition-1-21
		...
		:effect 
			(probabilistic
					0.061 (not (notfailed))
					0.939 (and (symbol_1 ?b) (not (symbol_12 ?b))))
	)
	...
	(:action option-3-partition-0-24
		...
		:effect 
			(probabilistic
					0.074 (not (notfailed))
					0.926 (and (symbol_16 ?d) (symbol_17 ?c) (symbol_18 ?b) (not (symbol_1 ?c)) (not (symbol_6 ?b)) (not (symbol_11 ?d))))
	)
	...
	(:action option-3-partition-0-25
		...
		:effect 
			(probabilistic
					0.066 (not (notfailed))
					0.934 (and (symbol_16 ?d) (symbol_17 ?c) (symbol_18 ?b) (not (symbol_1 ?c)) (not (symbol_6 ?b)) (not (symbol_11 ?d))))
	)
	...
	(:action option-3-partition-1-26
		...
		:effect 
			(probabilistic
					0.592 (not (notfailed))
					0.408 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_11 ?d)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-28
		...
		:effect 
			(probabilistic
					0.451 (not (notfailed))
					0.549 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_11 ?d)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-29
		...
		:effect 
			(probabilistic
					0.423 (not (notfailed))
					0.577 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)
	...
	(:action option-3-partition-1-30
		...
		:effect 
			(probabilistic
					0.384 (not (notfailed))
					0.616 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_11 ?d)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-31
		...
		:effect 
			(probabilistic
					0.398 (not (notfailed))
					0.602 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)
	...
	(:action option-4-partition-0-32
		...
		:effect 
			(probabilistic
					0.819 (not (notfailed))
					0.181 (and (symbol_19 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-4-partition-0-34
		...
		:effect 
			(probabilistic
					0.812 (not (notfailed))
					0.188 (and (symbol_19 ?a) (not (symbol_21 ?a))))
	)
	...
	(:action option-4-partition-0-35
		...
		:effect 
			(probabilistic
					0.781 (not (notfailed))
					0.219 (and (symbol_19 ?a) (not (symbol_22 ?a))))
	)
	...
	(:action option-4-partition-1-36
		...
		:effect 
			(probabilistic
					0.525 (not (notfailed))
					0.475 (and (symbol_21 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-4-partition-1-37
		...
		:effect 
			(probabilistic
					0.67 (not (notfailed))
					0.33 (and (symbol_21 ?a) (not (symbol_19 ?a))))
	)
	...
	(:action option-4-partition-1-39
		...
		:effect 
			(probabilistic
					0.673 (not (notfailed))
					0.327 (and (symbol_21 ?a) (not (symbol_22 ?a))))
	)

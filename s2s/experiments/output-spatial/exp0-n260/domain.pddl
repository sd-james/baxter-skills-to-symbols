...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.289 (not (notfailed))
					0.711 (and (symbol_20 ?d) (symbol_12 ?c) (symbol_6 ?b) (not (symbol_13 ?d)) (not (symbol_14 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-0-2
		...
		:effect 
			(probabilistic
					0.276 (not (notfailed))
					0.724 (and (symbol_20 ?d) (symbol_12 ?c) (symbol_6 ?b) (not (symbol_13 ?d)) (not (symbol_14 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-3
		...
		:effect 
			(probabilistic
					0.422 (not (notfailed))
					0.578 (and (symbol_11 ?d) (symbol_1 ?c) (symbol_6 ?b) (not (symbol_16 ?d)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-4
		...
		:effect 
			(probabilistic
					0.379 (not (notfailed))
					0.621 (and (symbol_11 ?d) (symbol_1 ?c) (symbol_6 ?b) (not (symbol_16 ?d)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-5
		...
		:effect 
			(probabilistic
					0.384 (not (notfailed))
					0.616 (and (symbol_11 ?d) (symbol_1 ?c) (symbol_6 ?b) (not (symbol_16 ?d)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-2-6
		...
		:effect 
			(probabilistic
					0.423 (not (notfailed))
					0.577 (and (symbol_11 ?c) (symbol_15 ?b) (not (symbol_0 ?c)) (not (symbol_3 ?b))))
	)
	...
	(:action option-1-partition-0-8
		...
		:effect 
			(probabilistic
					0.364 (not (notfailed))
					0.636 (and (symbol_13 ?c) (symbol_14 ?b) (not (symbol_16 ?c)) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-1-10
		...
		:effect 
			(probabilistic
					0.529 (not (notfailed))
					0.471 (and (symbol_14 ?b) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-1-11
		...
		:effect 
			(probabilistic
					0.653 (not (notfailed))
					0.347 (and (symbol_14 ?b) (not (symbol_17 ?b))))
	)
	...
	(:action option-2-partition-0-15
		...
		:effect 
			(probabilistic
					0.186 (not (notfailed))
					0.814 (and (symbol_17 ?b) (not (symbol_14 ?b))))
	)
	...
	(:action option-2-partition-0-16
		...
		:effect 
			(probabilistic
					0.119 (not (notfailed))
					0.881 (and (symbol_17 ?b) (not (symbol_14 ?b))))
	)
	...
	(:action option-2-partition-0-17
		...
		:effect 
			(probabilistic
					0.763 (not (notfailed))
					0.237 (and (symbol_17 ?b) (not (symbol_14 ?b))))
	)
	...
	(:action option-2-partition-1-21
		...
		:effect 
			(probabilistic
					0.057 (not (notfailed))
					0.943 (and (symbol_1 ?b) (not (symbol_12 ?b))))
	)
	...
	(:action option-3-partition-0-22
		...
		:effect 
			(probabilistic
					0.055 (not (notfailed))
					0.945 (and (symbol_16 ?d) (symbol_17 ?c) (symbol_18 ?b) (not (symbol_1 ?c)) (not (symbol_6 ?b)) (not (symbol_11 ?d))))
	)
	...
	(:action option-3-partition-0-23
		...
		:effect 
			(probabilistic
					0.119 (not (notfailed))
					0.881 (and (symbol_16 ?d) (symbol_17 ?c) (symbol_18 ?b) (not (symbol_1 ?c)) (not (symbol_6 ?b)) (not (symbol_11 ?d))))
	)
	...
	(:action option-3-partition-0-24
		...
		:effect 
			(probabilistic
					0.114 (not (notfailed))
					0.886 (and (symbol_16 ?d) (symbol_17 ?c) (symbol_18 ?b) (not (symbol_1 ?c)) (not (symbol_6 ?b)) (not (symbol_11 ?d))))
	)
	...
	(:action option-3-partition-1-25
		...
		:effect 
			(probabilistic
					0.877 (not (notfailed))
					0.123 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)
	...
	(:action option-3-partition-1-26
		...
		:effect 
			(probabilistic
					0.762 (not (notfailed))
					0.238 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_11 ?d)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-27
		...
		:effect 
			(probabilistic
					0.702 (not (notfailed))
					0.298 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)

	(:action option-3-partition-1-28
		:parameters (?a - type-1 ?b - type2 ?c - type33 ?d - type44)
		:precondition (and (notfailed) (symbol_21 ?a) (symbol_6 ?b) (symbol_12 ?c) (symbol_20 ?d))
		:effect 
			(probabilistic
					0.897 (not (notfailed))
					0.103 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)
	...
	(:action option-3-partition-1-29
		...
		:effect 
			(probabilistic
					0.538 (not (notfailed))
					0.462 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_11 ?d)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-30
		...
		:effect 
			(probabilistic
					0.517 (not (notfailed))
					0.483 (and (symbol_13 ?d) (symbol_14 ?c) (symbol_18 ?b) (not (symbol_6 ?b)) (not (symbol_12 ?c)) (not (symbol_20 ?d))))
	)
	...
	(:action option-4-partition-0-31
		...
		:effect 
			(probabilistic
					0.736 (not (notfailed))
					0.264 (and (symbol_19 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-4-partition-0-33
		...
		:effect 
			(probabilistic
					0.74 (not (notfailed))
					0.26 (and (symbol_19 ?a) (not (symbol_21 ?a))))
	)
	...
	(:action option-4-partition-1-35
		...
		:effect 
			(probabilistic
					0.703 (not (notfailed))
					0.297 (and (symbol_21 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-4-partition-1-36
		...
		:effect 
			(probabilistic
					0.672 (not (notfailed))
					0.328 (and (symbol_21 ?a) (not (symbol_19 ?a))))
	)
	...
	(:action option-4-partition-1-38
		...
		:effect 
			(probabilistic
					0.674 (not (notfailed))
					0.326 (and (symbol_21 ?a) (not (symbol_22 ?a))))
	)

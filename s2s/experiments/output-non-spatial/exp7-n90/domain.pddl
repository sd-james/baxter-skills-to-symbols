...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:precondition (and (notfailed) (symbol_17 ?a) (symbol_13 ?b) (symbol_12 ?c))
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_18 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_13 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_16 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-3-partition-1-8
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)

	(:action option-3-partition-1-9
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_11 ?b) (symbol_18 ?c))
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_18 ?c))))
	)
)
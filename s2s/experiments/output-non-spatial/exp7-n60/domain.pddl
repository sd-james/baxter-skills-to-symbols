...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_10 ?a) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_1 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-1-7
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-1-8
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b))))
	)
)
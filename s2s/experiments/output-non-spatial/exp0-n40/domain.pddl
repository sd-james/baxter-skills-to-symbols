...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.146 (not (notfailed))
					0.854 (and (symbol_13 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-1-3
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_14 ?a) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.144 (not (notfailed))
					0.856 (and (symbol_1 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.145 (not (notfailed))
					0.855 (and (symbol_17 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.144 (not (notfailed))
					0.856 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_13 ?b))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.144 (not (notfailed))
					0.856 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_12 ?c)) (not (symbol_13 ?b))))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_10 ?b) (symbol_11 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_13 ?c) (symbol_12 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.146 (not (notfailed))
					0.854 (and (symbol_15 ?a) (not (symbol_18 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_10 ?c))))
	)
	...
	(:action option-3-partition-1-7
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_12 ?b))))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?c)) (not (symbol_17 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.126 (not (notfailed))
					0.874 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_14 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.083 (not (notfailed))
					0.917 (and (symbol_1 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.101 (not (notfailed))
					0.899 (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-1-8
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_18 ?c) (symbol_10 ?b) (symbol_17 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_11 ?c))))
	)
)
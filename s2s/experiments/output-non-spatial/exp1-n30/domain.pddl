...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_15 ?c)) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_14 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-0-3
		...
		:effect 
			(probabilistic
					0.205 (not (notfailed))
					0.795 (and (symbol_10 ?a) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-1-4
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_1 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-5
		...
		:effect 
			(probabilistic
					0.095 (not (notfailed))
					0.905 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.095 (not (notfailed))
					0.905 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b))))
	)
)
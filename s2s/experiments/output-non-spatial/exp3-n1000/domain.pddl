...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect (and (symbol_14 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a)))
	)

	(:action option-0-partition-1-1
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_18 ?a) (symbol_13 ?b) (symbol_12 ?c))
		:effect (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_13 ?b)) (not (symbol_18 ?a)))
	)

	(:action option-0-partition-2-2
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_18 ?a) (symbol_17 ?b) (symbol_12 ?c))
		:effect (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a)))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a)))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect (and (symbol_17 ?a) (not (symbol_13 ?a)))
	)

	(:action option-3-partition-0-8
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_1 ?b) (symbol_14 ?c))
		:effect (and (symbol_16 ?c) (symbol_17 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_14 ?c)))
	)

	(:action option-3-partition-1-9
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_11 ?b) (symbol_10 ?c))
		:effect (and (symbol_12 ?c) (symbol_13 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b)))
	)

	(:action option-3-partition-1-10
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_11 ?b) (symbol_14 ?c))
		:effect (and (symbol_12 ?c) (symbol_13 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_14 ?c)))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect (and (symbol_10 ?c) (symbol_15 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_12 ?b)) (not (symbol_16 ?a)))
	)

	(:action option-0-partition-1-1
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_16 ?a) (symbol_18 ?b) (symbol_11 ?c))
		:effect (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b)))
	)

	(:action option-0-partition-2-2
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_16 ?a) (symbol_18 ?b) (symbol_17 ?c))
		:effect (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b)))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a)))
	)
	...
	(:action option-3-partition-0-9
		...
		:effect (and (symbol_11 ?c) (symbol_12 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_15 ?b)))
	)

	(:action option-3-partition-1-10
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_1 ?b) (symbol_13 ?c))
		:effect (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_13 ?c)))
	)
)
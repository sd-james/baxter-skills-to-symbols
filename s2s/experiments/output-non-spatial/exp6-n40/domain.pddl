...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?c)) (not (symbol_17 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.113 (not (notfailed))
					0.887 (and (symbol_14 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-1-3
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_15 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_10 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_14 ?b)))
	)

	(:action option-3-partition-0-7
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_14 ?b) (symbol_13 ?c))
		:effect (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b)))
	)
)
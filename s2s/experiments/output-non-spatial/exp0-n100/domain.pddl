...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_10 ?c) (symbol_15 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_12 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-3-3
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_13 ?b) (symbol_14 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.083 (not (notfailed))
					0.917 (and (symbol_15 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.126 (not (notfailed))
					0.874 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-2-partition-0-6
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_1 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_13 ?c))))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?c)) (not (symbol_17 ?a))))
	)

	(:action option-0-partition-1-1
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_17 ?a) (symbol_10 ?b) (symbol_18 ?c))
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_11 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_10 ?b)) (not (symbol_17 ?a)) (not (symbol_18 ?c))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_11 ?b) (symbol_14 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.059 (not (notfailed))
					0.941 (and (symbol_13 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_15 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_10 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_1 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_13 ?b))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_16 ?c) (symbol_15 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_12 ?c)) (not (symbol_13 ?b))))
	)

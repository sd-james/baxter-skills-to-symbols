...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_10 ?b) (symbol_11 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-2-3
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_15 ?b) (symbol_14 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_13 ?b))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.101 (not (notfailed))
					0.899 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_12 ?c)) (not (symbol_13 ?b))))
	)

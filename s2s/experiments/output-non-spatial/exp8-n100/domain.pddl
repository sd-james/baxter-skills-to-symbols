...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-3-3
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.059 (not (notfailed))
					0.941 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-0-6
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_17 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.056 (not (notfailed))
					0.944 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_16 ?c) (symbol_17 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-9
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.112 (not (notfailed))
					0.888 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?b)) (not (symbol_18 ?c))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_14 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_16 ?a)) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_17 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.059 (not (notfailed))
					0.941 (and (symbol_18 ?c) (symbol_17 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_10 ?c))))
	)
)
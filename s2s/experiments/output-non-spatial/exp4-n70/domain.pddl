...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_15 ?c)) (not (symbol_16 ?a)) (not (symbol_17 ?b))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_14 ?a) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_17 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
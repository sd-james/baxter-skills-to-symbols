...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_11 ?c) (symbol_12 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_13 ?b) (symbol_16 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.145 (not (notfailed))
					0.855 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_10 ?a)) (not (symbol_17 ?b))))
	)
	...
	(:action option-1-partition-2-4
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_12 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.112 (not (notfailed))
					0.888 (and (symbol_17 ?c) (symbol_10 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_13 ?c))))
	)
)
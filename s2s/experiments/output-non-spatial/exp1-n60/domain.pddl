...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:precondition (and (notfailed) (symbol_18 ?a) (symbol_11 ?b) (symbol_12 ?c))
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_10 ?c) (symbol_15 ?b) (symbol_6 ?a) (not (symbol_11 ?b)) (not (symbol_12 ?c)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_13 ?b) (symbol_14 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_12 ?b) (symbol_11 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.113 (not (notfailed))
					0.887 (and (symbol_17 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_1 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_16 ?c) (symbol_17 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_13 ?c))))
	)

	(:action option-3-partition-1-8
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_15 ?b) (symbol_10 ?c))
		:effect (and (symbol_12 ?c) (symbol_11 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_15 ?b)))
	)

	(:action option-3-partition-1-9
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_6 ?a) (symbol_15 ?b) (symbol_13 ?c))
		:effect (and (symbol_12 ?c) (symbol_11 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_15 ?b)))
	)
)
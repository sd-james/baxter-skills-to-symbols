...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_14 ?a) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_17 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
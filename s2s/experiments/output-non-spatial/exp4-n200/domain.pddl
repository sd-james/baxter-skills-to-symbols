...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.101 (not (notfailed))
					0.899 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_14 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-1-partition-1-5
		...
		:effect 
			(probabilistic
					0.393 (not (notfailed))
					0.607 (and (symbol_13 ?a) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-2-6
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-3-partition-1-11
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_14 ?c))))
	)
)
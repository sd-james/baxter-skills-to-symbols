...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-1-5
		...
		:effect 
			(probabilistic
					0.388 (not (notfailed))
					0.612 (and (symbol_15 ?a) (not (symbol_17 ?a))))
	)

...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_16 ?c) (symbol_17 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-9
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
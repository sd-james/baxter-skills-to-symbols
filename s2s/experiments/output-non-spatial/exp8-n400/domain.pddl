...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.067 (not (notfailed))
					0.933 (and (symbol_12 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)

	(:action option-0-partition-1-1
		:parameters (?a - type2 ?b - type33 ?c - type44)
		:precondition (and (notfailed) (symbol_18 ?a) (symbol_15 ?b) (symbol_14 ?c))
		:effect (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_18 ?a)))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.056 (not (notfailed))
					0.944 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.053 (not (notfailed))
					0.947 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)

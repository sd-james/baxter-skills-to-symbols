...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.112 (not (notfailed))
					0.888 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_15 ?c)) (not (symbol_16 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_15 ?b) (symbol_16 ?a) (not (symbol_10 ?a)) (not (symbol_17 ?b))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.146 (not (notfailed))
					0.854 (and (symbol_10 ?a) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_1 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_17 ?c) (symbol_10 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_11 ?c))))
	)
	...
	(:action option-3-partition-1-7
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-1-8
		...
		:effect 
			(probabilistic
					0.144 (not (notfailed))
					0.856 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b))))
	)
)
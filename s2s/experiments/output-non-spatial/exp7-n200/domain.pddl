...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.101 (not (notfailed))
					0.899 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.112 (not (notfailed))
					0.888 (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.059 (not (notfailed))
					0.941 (and (symbol_16 ?c) (symbol_17 ?b) (symbol_18 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_10 ?c))))
	)

...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:precondition (and (notfailed) (symbol_16 ?a) (symbol_18 ?b) (symbol_14 ?c))
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.084 (not (notfailed))
					0.916 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_18 ?a) (not (symbol_15 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
	...
	(:action option-3-partition-1-9
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_12 ?c))))
	)
)
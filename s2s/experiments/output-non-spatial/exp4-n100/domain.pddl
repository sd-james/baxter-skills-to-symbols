...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_13 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.083 (not (notfailed))
					0.917 (and (symbol_14 ?b) (symbol_15 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-1-partition-0-3
		...
		:effect 
			(probabilistic
					0.056 (not (notfailed))
					0.944 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.373 (not (notfailed))
					0.627 (and (symbol_13 ?a) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.2 (not (notfailed))
					0.8 (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-2-partition-0-6
		...
		:effect 
			(probabilistic
					0.062 (not (notfailed))
					0.938 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_18 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-0-9
		...
		:effect 
			(probabilistic
					0.063 (not (notfailed))
					0.937 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_14 ?c))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_17 ?c) (symbol_18 ?b) (symbol_16 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_14 ?c))))
	)
)
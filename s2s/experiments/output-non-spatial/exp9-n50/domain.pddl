...
(define (domain AosmEnv)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-0-3
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-3-partition-0-5
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_14 ?c) (symbol_15 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
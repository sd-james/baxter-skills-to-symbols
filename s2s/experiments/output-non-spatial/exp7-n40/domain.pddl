...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.126 (not (notfailed))
					0.874 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_15 ?c)) (not (symbol_16 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.205 (not (notfailed))
					0.795 (and (symbol_15 ?b) (symbol_16 ?a) (not (symbol_10 ?a)) (not (symbol_17 ?b))))
	)

...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_12 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_14 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.092 (not (notfailed))
					0.908 (and (symbol_12 ?b) (symbol_13 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.056 (not (notfailed))
					0.944 (and (symbol_18 ?a) (not (symbol_13 ?a))))
	)

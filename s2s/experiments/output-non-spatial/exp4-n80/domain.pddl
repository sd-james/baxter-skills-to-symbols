...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_15 ?c)) (not (symbol_16 ?a)) (not (symbol_17 ?b))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_14 ?a) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.083 (not (notfailed))
					0.917 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_17 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_11 ?b))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c))))
	)
)
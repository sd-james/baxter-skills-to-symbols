...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.083 (not (notfailed))
					0.917 (and (symbol_10 ?b) (symbol_18 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_14 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_12 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.062 (not (notfailed))
					0.938 (and (symbol_1 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-2-partition-1-6
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_16 ?a) (not (symbol_12 ?a))))
	)
	...
	(:action option-3-partition-1-8
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_11 ?c) (symbol_12 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_13 ?b))))
	)
)
...
(define (domain AosmEnv)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_16 ?a)) (not (symbol_18 ?b))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?a)) (not (symbol_17 ?c)) (not (symbol_18 ?b))))
	)

...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_10 ?b) (symbol_18 ?a) (not (symbol_0 ?b)) (not (symbol_3 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_13 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_16 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-0-partition-3-3
		...
		:effect 
			(probabilistic
					0.077 (not (notfailed))
					0.923 (and (symbol_13 ?c) (symbol_14 ?b) (symbol_6 ?a) (not (symbol_11 ?c)) (not (symbol_12 ?b)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-0-4
		...
		:effect 
			(probabilistic
					0.053 (not (notfailed))
					0.947 (and (symbol_14 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_11 ?b) (symbol_12 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-0-6
		...
		:effect 
			(probabilistic
					0.055 (not (notfailed))
					0.945 (and (symbol_1 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_16 ?a) (not (symbol_12 ?a))))
	)
	...
	(:action option-3-partition-0-8
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_15 ?c) (symbol_16 ?b) (symbol_17 ?a) (not (symbol_1 ?b)) (not (symbol_6 ?a)) (not (symbol_10 ?c))))
	)
	...
	(:action option-3-partition-1-9
		...
		:effect 
			(probabilistic
					0.055 (not (notfailed))
					0.945 (and (symbol_11 ?c) (symbol_12 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_14 ?b))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect 
			(probabilistic
					0.055 (not (notfailed))
					0.945 (and (symbol_11 ?c) (symbol_12 ?b) (symbol_17 ?a) (not (symbol_6 ?a)) (not (symbol_13 ?c)) (not (symbol_14 ?b))))
	)
)
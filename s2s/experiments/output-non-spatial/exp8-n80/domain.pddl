...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.201 (not (notfailed))
					0.799 (and (symbol_12 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_16 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-1-1
		...
		:effect 
			(probabilistic
					0.143 (not (notfailed))
					0.857 (and (symbol_10 ?c) (symbol_11 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_15 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-0-partition-2-2
		...
		:effect 
			(probabilistic
					0.168 (not (notfailed))
					0.832 (and (symbol_10 ?c) (symbol_1 ?b) (symbol_6 ?a) (not (symbol_14 ?c)) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-1-partition-2-5
		...
		:effect 
			(probabilistic
					0.071 (not (notfailed))
					0.929 (and (symbol_11 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-2-partition-1-7
		...
		:effect 
			(probabilistic
					0.072 (not (notfailed))
					0.928 (and (symbol_1 ?a) (not (symbol_11 ?a))))
	)
	...
	(:action option-3-partition-1-10
		...
		:effect (and (symbol_14 ?c) (symbol_15 ?b) (symbol_18 ?a) (not (symbol_6 ?a)) (not (symbol_11 ?b)) (not (symbol_12 ?c)))
	)
)
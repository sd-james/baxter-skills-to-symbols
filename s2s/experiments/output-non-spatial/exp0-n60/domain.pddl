...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.126 (not (notfailed))
					0.874 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-1-partition-0-2
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_13 ?a) (not (symbol_1 ?a))))
	)
	...
	(:action option-1-partition-2-3
		...
		:effect 
			(probabilistic
					0.202 (not (notfailed))
					0.798 (and (symbol_15 ?b) (symbol_14 ?a) (not (symbol_17 ?b)) (not (symbol_18 ?a))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.111 (not (notfailed))
					0.889 (and (symbol_1 ?a) (not (symbol_13 ?a))))
	)

...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.167 (not (notfailed))
					0.833 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_14 ?b)) (not (symbol_15 ?c)) (not (symbol_16 ?a))))
	)
	...
	(:action option-2-partition-0-4
		...
		:effect 
			(probabilistic
					0.1 (not (notfailed))
					0.9 (and (symbol_1 ?a) (not (symbol_13 ?a))))
	)
	...
	(:action option-2-partition-1-5
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_17 ?a) (not (symbol_14 ?a))))
	)
	...
	(:action option-3-partition-0-6
		...
		:effect 
			(probabilistic
					0.082 (not (notfailed))
					0.918 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_10 ?c)) (not (symbol_13 ?b))))
	)
	...
	(:action option-3-partition-0-7
		...
		:effect 
			(probabilistic
					0.082 (not (notfailed))
					0.918 (and (symbol_15 ?c) (symbol_14 ?b) (symbol_16 ?a) (not (symbol_6 ?a)) (not (symbol_12 ?c)) (not (symbol_13 ?b))))
	)
)
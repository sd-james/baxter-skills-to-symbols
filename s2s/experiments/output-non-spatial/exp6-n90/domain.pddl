...
(define (domain AosmEnv)
	...
	(:action option-0-partition-0-0
		...
		:effect 
			(probabilistic
					0.092 (not (notfailed))
					0.908 (and (symbol_12 ?c) (symbol_13 ?b) (symbol_6 ?a) (not (symbol_15 ?b)) (not (symbol_16 ?c)) (not (symbol_17 ?a))))
	)
	...
	(:action option-1-partition-1-4
		...
		:effect 
			(probabilistic
					0.125 (not (notfailed))
					0.875 (and (symbol_15 ?a) (not (symbol_10 ?a))))
	)
	...
	(:action option-2-partition-0-5
		...
		:effect 
			(probabilistic
					0.091 (not (notfailed))
					0.909 (and (symbol_10 ?a) (not (symbol_15 ?a))))
	)

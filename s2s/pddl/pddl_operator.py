...
class PDDLOperator:
    ...
    def score(self, state: np.ndarray):
        warnings.warn("Must account for different masks!")
        return self._learned_operator.precondition.probability(state)

class _PrettyPrint:


    def __init__(self, operator: PDDLOperator, index=None, probabilistic=True, use_rewards=True,
